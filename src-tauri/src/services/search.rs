...
impl<'a> SearchService<'a> {
    ...
    pub fn dashboard(&self, payday: u32) -> AppResult<DashboardStats> {
        ...
        Ok(DashboardStats {
            ...
            pay_period_income: finance.pay_period.income,
            pay_period_expense: finance.pay_period.expense,
            pay_period_label: finance.pay_period_label.clone(),
            pay_period_effective: finance.pay_period_glance.effective,
            pay_period_opening: finance.pay_period_glance.opening,
            pay_period_opening_missing: finance.pay_period_glance.opening_missing,
            pay_period_due_this_period: finance.pay_period_glance.due_this_period,
            pay_period_after_debts: finance.pay_period_glance.after_debts,
